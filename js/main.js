$(function(){
  ...
  $('.icon-menu').click(function(){
    $(this).hide('drop', 200, function(){
      $('.icon-close').show('fade', 1000)
    })
    //$('.layout-sidebar').toggle('slide',{direction: 'left'}, 500)
    //$(".layout-sidebar").animate({'right': '0px'}, 500)
    $("#content").animate({'left': '-260px'}, 500)
  })
  $('.icon-close').click(function(){
    $(this).hide('drop', 200, function(){
      $('.icon-menu').show('fade', 1000)
    })
    //$('.layout-sidebar').toggle('slide',{direction: 'left'}, 500)
    //$(".layout-sidebar").animate({'right': '-260px'}, 500)
